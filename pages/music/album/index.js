...
export default function AlbumIndex(props) {
    ...
    const { data } = useSWR(`album?page=${page}`, get, { initialData: props.data });

    const title = t("Музыкальные альбомы");
            ...
            <div className="container min-view inner-page">
                ...
                <div className="row">
                    ...
                    <div className="col-md-9">
                        <h2 className="title-2 mt-0 mb-2 mb-md-4 pb-2">{t("Альбомы")}</h2>
...
export const getServerSideProps = withSession(async function ({ req, res, query: { page = 1 }, locale }) {
    ...
    try {
        let data = await get(`album?page=${page}`, params);
