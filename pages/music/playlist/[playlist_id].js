...
export default function PlaylistView(props) {
    ...
    const title = t("Плейлист") + " " + model['name_' + i18n.language];
                    ...
                    <div className="album-page">
                        <div className="details">
                            <div className="d-flex">
                                ...
                                <div className="info">
                                    <h2 className="mt-0">{t("Плейлист")}</h2>
                                    <h1>{model['name_' + i18n.language]}</h1>
                                    <p className="singer">{t("Обновлён")} <a role="button" className="cursor-default no-hover">{moment(model.updated_at, "YYYY-MM-DD").locale(i18n.language === 'uz' ? "uz-latn" : 'ru').format(moment().year() == moment(model.updated_at, "YYYY-MM-DD").format("YYYY") ? "DD MMMM" : "DD.MM.YYYY")}</a></p>
                            ...
                            {models.length > 0 && <>
                                ...
                                <Link href={"/music/playlist"}>
                                    <nav className="title-nav cursor-pointer mt-5">
                                        <a>
                                            <h3 className={"title-2 mb-0 mt-0"}>{t("Другие плейлисты")}</h3>
                                        </a>
                                                    ...
                                                    <a>
                                                        <div className="album">
                                                            ...
                                                            <div className="info">
                                                                ...
                                                                <p className="year">{moment(model.release_date, "YYYY-MM-DD").format("YYYY")} {t("Плейлист")}</p>
                                                            </div>
                                                        </div>
                                                    </a>
                                                </Link>
