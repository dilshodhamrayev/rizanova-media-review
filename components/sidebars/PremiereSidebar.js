...
export default function PremiereSidebar() {
    ...
    const menus = [
        {
            name: t("Все"),
            isActive: router.pathname === "/premiere",
            link: "/premiere"
        },
        {
            name: t("Клипы"),
            isActive: router.pathname === "/premiere/clip",
            link: "/premiere/clip"
        },
        {
            name: t("Музыка"),
            isActive: router.pathname === "/premiere/music",
            link: "/premiere/music"
        },
        {
            name: t("Фильмы"),
            isActive: router.pathname === "/premiere/film",
            link: "/premiere/film"
        },
        {
            name: t("Сериалы"),
            isActive: router.pathname === "/premiere/serial",
            link: "/premiere/serial"
        },
        {
            name: t("Юмор"),
            isActive: router.pathname === "/premiere/humor",
            link: "/premiere/humor"
        },
    ]
