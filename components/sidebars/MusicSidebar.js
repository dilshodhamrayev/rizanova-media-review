...
export default function MusicSidebar() {
    ...
    const menus = [
        {
            name: t("Все"),
            isActive: router.pathname === "/music" || router.pathname === "/music/[music_id]" || router.pathname === "/music/all",
            link: "/music"
        },
        {
            name: t("Премьера"),
            isActive: router.pathname === "/music/premiere",
            link: "/music/premiere"
        },
        // {
        //     name: t("Плейлисты"),
        //     isActive: router.pathname.startsWith("/music/playlist"),
        //     link: "/music/playlist"
        // },
        {
            name: t("Альбомы"),
            isActive: router.pathname.startsWith("/music/album"),
            link: "/music/album"
        },
        {
            name: t("Чарт RizaNova"),
            isActive: router.pathname === "/music/chart",
            link: "/music/chart"
        },
        {
            name: t("Исполнители"),
            isActive: router.pathname === "/music/singer",
            link: "/music/singer"
        },
        {
            name: t("Категории"),
            isActive: router.pathname.startsWith("/music/category"),
            link: "/music/category"
        },
    ]
